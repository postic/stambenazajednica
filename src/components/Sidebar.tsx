  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Kvarovi", icon: Wrench, href: "/kvarovi", badge: kvarCount },
        { title: "Obaveštenja", icon: Megaphone, href: "/obavestenja", badge: newsCount },
                          ...
                          >
                            ...
                            {!collapsed && (
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-xl w-6 text-center font-bold">{isOpen ? "−" : "+"}</span>
                              </div>
                            )}
                          </button>
                                ...
                                <li key={sub.href}>
                                  <Link
                                    ...
                                    className={`block p-2 rounded-lg hover:bg-slate-700 ${
                                      pathname === sub.href ? "bg-slate-700" : ""
                                    }`}
                                  >
                                    {sub.title}
                                  </Link>
