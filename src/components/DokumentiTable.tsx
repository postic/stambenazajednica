            ...
            <tr key={o.id} className="hover:bg-gray-50 transition">
              ...
              <td className="px-4 py-2">
                <div className="flex justify-center items-center gap-3 whitespace-nowrap">
                  <Link href={`/dokumenti/${o.id}`} className="p-1 rounded hover:bg-gray-200 text-gray-600 hover:text-blue-600"><Eye size={18} /></Link>
                  <Link href={`/dokumenti/${o.id}/edit`} className="p-1 rounded hover:bg-gray-200 text-gray-600 hover:text-green-600"><Pencil size={18} /></Link>
